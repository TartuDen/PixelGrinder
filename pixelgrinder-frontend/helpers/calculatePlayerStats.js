...
import {
   ...
   * e.g. if base = 10, final damage could be 8 to 12.
   */
  ...
  /**
   * Calculate damage for a melee attack (attacker's meleeAttack vs. defender's meleeDefense).
   */
  ...
  /**
   * Calculate damage for a magic attack (attacker's magicAttack vs. defender's magicDefense).
   */
